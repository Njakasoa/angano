...
**96 fichiers attendus** · 0 à générer · 16.9 Mo · 18.3 min
...
| `vo_role_mponina.mp3` | 152 | 9.7 | voix statique | Tu es Mponina. Un villageois sans pouvoir. T… | — | `--voice` |
| `vo_role_songomby.mp3` | 122 | 7.8 | voix statique | Tu es Songomby. La bête qui dévore. Chaque n… | — | `--voice` |
| `vo_role_mpisikidy.mp3` | 157 | 10.0 | voix statique | Tu es Mpisikidy. Les graines du sikidy te pa… | — | `--voice` |
| `vo_role_ombiasy.mp3` | 137 | 8.7 | voix statique | Tu es Ombiasy. Un remède, un rituel d'exil. … | — | `--voice` |
| `vo_role_fanany.mp3` | 135 | 8.6 | voix statique | Tu es Fanany, serpent des ancêtres. Marque u… | — | `--voice` |
| `vo_role_zazavavindrano.mp3` | 146 | 9.3 | voix statique | Tu es Zazavavindrano, esprit des eaux. Pose … | — | `--voice` |
| `vo_role_kalanoro.mp3` | 135 | 8.6 | voix statique | Tu es Kalanoro. Tes pieds sont inversés, tes… | — | `--voice` |
| `vo_role_kinoly.mp3` | 122 | 7.8 | voix statique | Tu es Kinoly, un revenant qui s'ignore encor… | — | `--voice` |
| `vo_role_mpamosavy.mp3` | 125 | 7.9 | voix statique | Tu es Mpamosavy, sorcier de l'ombre. Maudis … | — | `--voice` |
| `vo_victory_village.mp3` | 97 | 6.2 | voix statique | Le village a chassé tous les monstres. L'aub… | — | `--voice` |
| `vo_victory_songomby.mp3` | 98 | 6.2 | voix statique | Les Songomby ont fait taire le village. Plus… | — | `--voice` |
...
| `vo_lj_prose_01.mp3` | 458 | 29.3 | pack · lac-jarres-blanches | intro | oui | `--pack=lac-jarres-blanches` |
...
| `vo_lj_prose_06.mp3` | 175 | 11.1 | pack · lac-jarres-blanches | nuit_zazavavindrano | oui | `--pack=lac-jarres-blanches` |
...
| `vo_lj_prose_21.mp3` | 164 | 10.4 | pack · lac-jarres-blanches | victoire_village | oui | `--pack=lac-jarres-blanches` |
...
| `vo_lj_reveal_ombiasy.mp3` | 160 | 10.2 | pack · lac-jarres-blanches | reveal_ombiasy | oui | `--pack=lac-jarres-blanches` |
...
| `vo_lj_reveal_kalanoro.mp3` | 178 | 11.4 | pack · lac-jarres-blanches | reveal_kalanoro | oui | `--pack=lac-jarres-blanches` |
| `vo_lj_reveal_kinoly.mp3` | 165 | 10.5 | pack · lac-jarres-blanches | reveal_kinoly | oui | `--pack=lac-jarres-blanches` |
| `vo_lj_reveal_mpamosavy.mp3` | 155 | 9.8 | pack · lac-jarres-blanches | reveal_mpamosavy | oui | `--pack=lac-jarres-blanches` |
| `vo_lj_vote_sentence.mp3` | 146 | 9.3 | pack · lac-jarres-blanches | vote_sentence | oui | `--pack=lac-jarres-blanches` |
| `vo_lj_vote_personne.mp3` | 149 | 9.4 | pack · lac-jarres-blanches | vote_personne | oui | `--pack=lac-jarres-blanches` |
| `vo_lj_razana_vengeance.mp3` | 209 | 13.3 | pack · lac-jarres-blanches | razana_vengeance | oui | `--pack=lac-jarres-blanches` |
